      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className=''>
          <ul className="flex  items-center gap-3">
            <li><Link href="/" className="text-xl p-4 hover:underline">ホーム</Link></li>
            <li><Link href="/activities" className="text-xl p-4 hover:underline">活動内容</Link></li>
            <li><Link href="/result" className="text-xl p-4 hover:underline">大会の結果</Link></li>
            <li><Link href="/album" className="text-xl p-4 hover:underline">アルバム</Link></li>
            <li><Button variant="secondary">
              <span className='mx-2'>
              お問い合わせ
              </span>
