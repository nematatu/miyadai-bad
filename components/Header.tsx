...
function NavItems() {
  return (
    <ul className="flex flex-col md:flex-row items-start md:items-center gap-3">
      <li><Link href="/" className="text-lg md:text-xl p-2 md:p-4 hover:underline block">ホーム</Link></li>
      <li><Link href="/activities" className="text-lg md:text-xl p-2 md:p-4 hover:underline block">活動内容</Link></li>
      <li><Link href="/result" className="text-lg md:text-xl p-2 md:p-4 hover:underline block">大会の結果</Link></li>
      <li><Link href="/album" className="text-lg md:text-xl p-2 md:p-4 hover:underline block">アルバム</Link></li>
      <li>
